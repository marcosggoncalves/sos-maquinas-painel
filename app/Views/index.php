      ...
      <div class="row">
        ...
        <div class="col-lg-4">
         ...
         <div class="alert alert-warning alert-dismissible">
            <h4><i class="icon fa fa-cloud-download"></i>Aplicativo - 1.2.0</h4>
            <p> Baixar versão estável do aplicativo <b>SOS Máquinas: <a href="public/app-v1.2.apk" >Baixar</a></b></p>
          </div>
